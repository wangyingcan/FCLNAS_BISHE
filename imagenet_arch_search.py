...
if __name__ == '__main__':
    ...
    # run_config is initialized in line.122
    ...
    user_groups = []
    idx = 0
    user_groups[idx] = [0, 1, 2, 3]
    # self.arch_search_config.target_hardware
    arch_search_run_manager.arch_search_config.target_hardware = 'flops'
    arch_search_run_manager.run_manager.run_config.user_groups_image_id = user_groups[idx]
    arch_search_run_manager.train(fix_net_weights=args.debug, user_groups_image_id=user_groups[idx])
